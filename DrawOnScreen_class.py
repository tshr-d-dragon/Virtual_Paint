# -*- coding: utf-8 -*-
"""
Created on Wed Apr 28 22:11:46 2021
...
def main():
    ...
    # result = cv2.VideoWriter('C:/Users/1636740/Desktop/tshr/cv2/DrawOnScreen_3.avi',  
    ...
    while video.isOpened():
        ...
        imgArray = ([frame, canvas],[canvas_inv, output])
        scale = 0.5
        # labels = [['frame', 'canvas'], ['canvas_inv', 'output']]
        final = Stack_Images(imgArray, scale)
